...
function allowedExtensionsLabel(record: SharedServiceFields) {
  ...
  if (mode.includes("backup")) {
    return "Backup / see notes";
  }

  if (mode.includes("mod")) {
    return "Mods / see notes";
  }

  if (mode.includes("alias")) {
    return "Alias / see notes";
  }

  if (mode.includes("generic") || mode.includes("general")) {
    return "General / see notes";
  }

  if (mode.includes("configurable")) {
    return "Configurable";
  }
  ...
  if (mode.includes("unidentified")) {
    return "Unidentified";
  }

  if (mode.includes("rejected")) {
    return "Rejected / see notes";
  }

  if (mode.includes("unverified")) {
    return "Unverified";
  }
