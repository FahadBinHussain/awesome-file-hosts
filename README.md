...
- [Baidu Pan](https://pan.baidu.com/) - Baidu's large-scale cloud storage service with multi-device backup, file sharing, iPhone/Mac apps, an official PCS open platform, and very large paid expansion tiers. _(Max: Not published | Retention: Conditional | Account: Yes | API)_
...
- [Disroot Upload](https://disroot.org/en/services/upload) - Privacy-focused temporary file sharing from Disroot, powered by Lufi and encrypted in the browser before upload. _(Max: Not published | Retention: Conditional | Account: No | E2EE)_
