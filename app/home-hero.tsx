  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[15%] top-[40%] h-[400px] w-[400px] animate-pulse rounded-full bg-purple-500 opacity-[0.06] blur-[100px]" style={{ animationDuration: "10s", animationDelay: "2s" }} />
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:py-32">
        ...
        <div className="animate-fade-in-up mb-8 flex justify-center">
          <div className="group inline-flex items-center gap-2 rounded-full border border-[var(--line)] bg-[rgba(255,255,255,0.02)] px-4 py-2 backdrop-blur-xl transition-all hover:border-[var(--accent)]/30 hover:bg-[rgba(255,255,255,0.04)]">
        ...
        <div className="animate-fade-in-up mb-6 text-center" style={{ animationDelay: "0.1s" }}>
          <h1 className="mx-auto max-w-5xl text-5xl font-bold leading-[1.1] tracking-tight text-white md:text-7xl lg:text-8xl">
            ...
            <span className="relative mx-3 inline-block">
              <span className="relative z-10 bg-gradient-to-r from-[var(--accent)] via-purple-400 to-[var(--accent)] bg-clip-text text-transparent">
                file host
              </span>
              <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-[var(--accent)] via-purple-400 to-[var(--accent)] opacity-20 blur-2xl" />
            </span>
        ...
        <div className="animate-fade-in-up grid gap-4 sm:grid-cols-2 lg:grid-cols-4" style={{ animationDelay: "0.4s" }}>
          {[
            ...
            <div
              key={stat.label}
              className="group relative overflow-hidden rounded-3xl border border-[var(--line)] bg-[rgba(255,255,255,0.02)] p-6 backdrop-blur-xl transition-all hover:border-[var(--line-strong)] hover:bg-[rgba(255,255,255,0.04)]"
              style={{ animationDelay: `${0.5 + i * 0.1}s` }}
            >
              <div className="relative z-10">
                <div className={`mb-3 inline-flex rounded-2xl bg-gradient-to-br ${stat.color} p-3 opacity-90`}>
