        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          <div className="group/card rounded-[var(--radius-panel)] border border-[var(--line)] bg-gradient-to-br from-[var(--surface-1)] to-[var(--surface-2)] p-4 backdrop-blur-sm transition-all hover:border-[var(--accent)]/30 hover:shadow-[0_8px_24px_-8px_var(--accent-glow)]">
            ...
            <div className="mt-2 text-sm font-medium text-[var(--text-primary)]">
              ...
              <SourceRefLinks record={host} refs={host.developer.source_refs} />
            </div>
            <div className="mt-1 text-xs text-[var(--text-muted)]">
              {host.developer.cli_friendly ? "CLI-friendly" : "No CLI"}
            </div>
          </div>
          <div className="group/card rounded-[var(--radius-panel)] border border-[var(--line)] bg-gradient-to-br from-[var(--surface-1)] to-[var(--surface-2)] p-4 backdrop-blur-sm transition-all hover:border-[var(--accent)]/30 hover:shadow-[0_8px_24px_-8px_var(--accent-glow)]">
            ...
            <div className="mt-2 text-sm font-medium text-[var(--text-primary)]">
              ...
              <SourceRefLinks record={host} refs={host.security.source_refs} />
            </div>
            <div className="mt-1 text-xs text-[var(--text-muted)]">
              {host.security.https_only ? "HTTPS only" : "Mixed/unknown HTTP policy"}
            </div>
          </div>
          <div className="group/card rounded-[var(--radius-panel)] border border-[var(--line)] bg-gradient-to-br from-[var(--surface-1)] to-[var(--surface-2)] p-4 backdrop-blur-sm transition-all hover:border-[var(--accent)]/30 hover:shadow-[0_8px_24px_-8px_var(--accent-glow)]">
            ...
            <div className="mt-2 text-sm font-medium text-[var(--text-primary)]">
              {host.accountLabel} <SourceRefLinks record={host} refs={host.account.source_refs} />
            </div>
          </div>
        </div>
